      ...
      <div className="container-fluid">
        <div className="row">
          <h1 className="itemListContainer-title">{props.greeting}{categoryId && categoryId}</h1>
          {
            ...
            <div className="loader"><ArrowClockwise className="image_rotate" size={80}/></div> 
            : error ? <p className="alerta-error alert alert-danger">{error}</p> : <ItemList items={productos} />
          }
        </div>
      </div>
    </section>
